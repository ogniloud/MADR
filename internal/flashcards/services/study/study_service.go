...
type IStudyService interface {
	...
	MakeText(generator IPalmService, uid models.UserId, down models.CoolDown, size int) (models.Text, error)
}
...
func (s Service) MakeText(generator IPalmService, uid models.UserId, down models.CoolDown, size int) (models.Text, error) {
	cardIds := s.GetNextRandomN(uid, down, size)
	cards := make(map[string]models.Flashcard)
	var words []string = nil
