...
export const createDeck = async (deckData, token) => {
    try {
        const response = await axios.put(
            `${process.env.REACT_APP_API_HOST}/api/flashcards/new_deck`,
            deckData,
            {
                headers: {
...
export const fetchUserDecks = async (token) => {
    try {
        ...
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/flashcards/load`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const deleteDeck = async (deckId, userId, token) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/flashcards/delete_deck`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
...
export const checkIfShared = async (deckId, userId, token) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/social/is_shared`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
...
export const shareDeck = async (deckId, userId, token) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/social/share`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
...
export const checkIfSharedByGroups = async (deckId, userId, token) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/social/groups_shared`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
...
export const shareGroup = async (userId, groupId, deckId, token) => {
    try {
        const response = await fetch(`${process.env.REACT_APP_API_HOST}/api/groups/share`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
